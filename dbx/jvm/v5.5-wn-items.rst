...
.. note::
   ...
   The tests were conducted on the ``localhost`` server with a
   negligible network latency. In higher-latency environments, 
   you might see less significant performance improvements.
